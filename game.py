...
while True:
    ...
    if time.time()-timeStart < totalTime:
        ...
        if hands:
            ...
            x1 = lmList[5][0]  # Extract x coordinate from lmList[5]
            y1 = lmList[5][1]  # Extract y coordinate from lmList[5]
        
            x2 = lmList[17][0]  # Extract x coordinate from lmList[17]
            y2 = lmList[17][1]  # Extract y coordinate from lmList[17]
